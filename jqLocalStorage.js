...
(function($, window) {
    ...
    jqLocalStorage.prototype.replaceRelativeURLWithFullURL = function(segments, url_fragment, text) {
    ...
    jqLocalStorage.prototype.replaceURLs = function(url, text) {
    ...
    jqLocalStorage.prototype.loadStyleContentAndCacheIt = function(url, data) {
        ...
        return $.get(url).then(function(text, success, Promise) {
            data.text = self.cssmin(text);
            data.text = self.replaceURLs(url, data.text);
